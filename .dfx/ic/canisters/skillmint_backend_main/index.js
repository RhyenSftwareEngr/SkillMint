...
import { idlFactory } from './skillmint_backend_main.did.js';
export { idlFactory } from './skillmint_backend_main.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILLMINT_BACKEND_MAIN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skillmint_backend_main.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skillmint_backend_main canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skillmint_backend_main.did.js")._SERVICE>}
 */
export const skillmint_backend_main = createActor(canisterId);
