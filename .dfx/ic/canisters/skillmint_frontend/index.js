...
import { idlFactory } from './skillmint_frontend.did.js';
export { idlFactory } from './skillmint_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILLMINT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skillmint_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skillmint_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skillmint_frontend.did.js")._SERVICE>}
 */
export const skillmint_frontend = createActor(canisterId);
